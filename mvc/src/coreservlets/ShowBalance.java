 ...
 * on servlets, JSP, Struts, JSF, Ajax, GWT, Spring, Hibernate/JPA, and Java programming</a>.
 */
...
public class ShowBalance extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    Customer customer = service.findCustomer(customerId); // OK to pass null or empty String to
                                                          // findCustomer
